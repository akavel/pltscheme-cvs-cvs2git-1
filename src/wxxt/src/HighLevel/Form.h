/*								-*- C++ -*-
 * $Id: Form.h,v 1.1.1.1 1997/12/22 17:28:52 mflatt Exp $
 *
...
#define wxFORM_BUTTON_ALL 	  (  wxFORM_BUTTON_OK     | wxFORM_BUTTON_CANCEL\
				   | wxFORM_BUTTON_UPDATE | wxFORM_BUTTON_REVERT)
