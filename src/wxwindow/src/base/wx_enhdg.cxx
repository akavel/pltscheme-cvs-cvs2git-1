 ...
 * Created:	1993
 * Updated:	August 1994
 * RCS_ID:      $Id: wx_enhdg.cxx,v 1.1.1.1 1997/12/22 16:11:57 mflatt Exp $
...
{
   Create(Parent, Title, Modal, fun, space, x, y, width, height, Style, name);
}

Bool wxEnhDialogBox::Create(wxFrame *Parent, char *Title, Bool Modal, 
                         wxFunction fun,int space,
                         int x, int y, int width, int height,
			 long Style, char *name)
{
  wxDialogBox::Create(Parent,Title,Modal,x,y,width,height,Style,name) ;
