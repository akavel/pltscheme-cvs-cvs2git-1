;;
;;  zodiac:scanner-code@
;;  $Id: scanner.ss,v 1.2 1997/04/28 18:56:54 shriram Exp $
;;
...
;; SCANNER read scalar symbol number string boolean char external sequence list vector improper
...
(unit/sig  zodiac:scanner-code^
   ...
   ;;  file = copied from location of init-loc.
       ...
       (let*
        ...
        ;; disable the skip-script feature for now
        ;; since we can't do peek-char on thunks.
